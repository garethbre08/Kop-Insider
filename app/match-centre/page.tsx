...
const results = [
  { opponent: "Everton",      liverpoolScore: 3, opponentScore: 0, competition: "Premier League", date: "Sun 26 Jan 2025", outcome: "win"  },
  { opponent: "Tottenham",    liverpoolScore: 1, opponentScore: 1, competition: "FA Cup",          date: "Wed 22 Jan 2025", outcome: "draw" },
  { opponent: "Nottm Forest", liverpoolScore: 0, opponentScore: 1, competition: "Premier League", date: "Sat 18 Jan 2025", outcome: "loss" },
];

const fixtures = [
  { opponent: "Man City", competition: "Premier League",  date: "Sat 1 Feb 2025",  time: "17:30", venue: "H" },
  { opponent: "PSG",      competition: "Champions League", date: "Tue 4 Feb 2025",  time: "20:00", venue: "A" },
  { opponent: "Arsenal",  competition: "Premier League",  date: "Sun 9 Feb 2025",  time: "16:30", venue: "H" },
];
            ...
            <section>
              ...
              <div className="flex flex-col gap-3">
                {results.map((result, i) => (
                  <div
                    key={i}
                    className={`ki-card border-l-4 ${outcomeBorder[result.outcome]} p-4 flex items-center gap-4`}
                  >
            ...
            <section>
              ...
              <div className="flex flex-col gap-3">
                {fixtures.map((fixture, i) => (
                  <div key={i} className="ki-card p-4 flex items-center gap-4 flex-wrap">
                    <div className="flex items-center gap-3 flex-1 justify-end">
                      <span className="text-ki-black font-semibold text-sm hidden sm:block">Liverpool</span>
                      <CrestCircle variant="liverpool" />
                    </div>
                    ...
                    <div className="flex flex-col items-end gap-1 shrink-0 min-w-[140px]">
                      <div className="flex items-center gap-2">
                        <span className={`text-xs font-bold rounded px-2 py-0.5 ${fixture.venue === "H" ? `${accentBg} text-ki-white` : "bg-ki-sand text-ki-charcoal"}`}>
